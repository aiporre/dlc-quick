...
# if not os.path.exists(os.path.join(basepath,'Reaching-Mackenzie-2018-08-30','videos')):
#     os.makedirs(os.path.join(basepath,'Reaching-Mackenzie-2018-08-30','videos'))
